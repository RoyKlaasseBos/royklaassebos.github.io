<html>
  ...
  <body>
    ...
    <ol> 
      ...
      <li>
        <h3 class="counter" id="programming"> Python Programming</h3>
        <ol>
          ...
          <div class="recommendation">
           ...
           <p><i>Tip 1: Do the interactive demo <a href="http://generalassembly.github.io/prework/cl/" target="_blank">“How to use the command line“</a> (by General Assembly) in advance to be more comfortable with the terminal.</i></p>
         ...
         <!-- ======================================================================== -->
          <div class="recommendation">
            <h4>
              <li class="counter">
                <a href="https://www.youtube.com/playlist?list=PL5-da3qGB5ICCsgW1MxlZ0Hq8LL5U3u9y" target="_blank"> Data Analysis in Python with pandas</a>
              </li>
            </h4>

            <div class="embed-container">
              <iframe src="https://www.youtube.com/embed/yzIMircGU5I" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
            </div>
            ...
            <table>
                ...
                <tr>
                  <td><a href="https://www.youtube.com/channel/UCnVzApLJE2ljPZSeQylSEyg" target="_blank">Data School</a></td>
                  <td>Introductory</td>
                  <td>7</td>
                  <td>99%</td>
                  <td><a href="https://github.com/justmarkham/pandas-videos" target="_blank">Github</a></td>
      ...
      <li>
        <h3 class="counter" id="data-visualization"> Data Visualization</h3>
        <ol>
     ...
     <!-- ======================================================================== -->
      ...
      <li>
        <h3 class="counter" id="statistics"> Statistics & Probability</h3>
        <ol>
      ...
      <li>
        <h3 class="counter" id="machine-learning"> Machine Learning</h3>
          <ol>  
    ...
    <div class="faq">
      ...
      <h4><i>The title says "Top Data Science Videos 2018" but most of the content originates from way before 2018, isn't it?</i></h4>
      <hr>
